...
namespace MIT_student_hub.Controllers
{
    public class AccomodationController : Controller
    {
        ...
        public AccomodationController(IConfiguration iconfiguration)
        {
        ...
        public IActionResult Index()
        {
            ...
            if (!string.IsNullOrEmpty(user))
            {
                ...
                try
                {
                    ...
                    List<UserDataModel> listob = GetAllAccomodationList();
                    ViewData["AllAccomodationlist"] = Convert.ToString(listob[0].MessageString);
                }
                catch (Exception ex)
                {
        ...
        public ActionResult PostForm(PostModel postvalues)
        {
            ...
            if (!string.IsNullOrEmpty(userName))
            {
                ...
                {
                    con.Open();
                    SqlCommand dCmd = new SqlCommand("Update_Accomodation_Post", con);
        ...
        {
            List<UserDataModel> Listalljob = GetAllAccomodationList();
            return View(Listalljob);
        }

        public List<UserDataModel> GetAllAccomodationList()
        {
            SqlDataReader sqdr;
            List<UserDataModel> PostModelList = new List<UserDataModel>();
            SqlConnection con = new SqlConnection(ConnectionString);
            ...
            {
                con.Open();
                SqlCommand JCmdlist = new SqlCommand("GetAllAccomodationPost", con);
