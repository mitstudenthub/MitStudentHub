...
namespace MIT_student_hub.Controllers
{
    public class TravelController : Controller
    {
        ...
        public TravelController(IConfiguration iconfiguration)
        {
        ...
        public IActionResult Index()
        {
            ...
            if (!string.IsNullOrEmpty(user))
            {
                ...
                {
                    con.Open();
                    SqlCommand JCmd = new SqlCommand("GetTravelByUser", con);
                    JCmd.CommandType = CommandType.StoredProcedure;
                    JCmd.Parameters.Add(new SqlParameter("@Userid", user));
                    JCmd.Parameters.Add(new SqlParameter("@Posttype", 'T'));
                    ...
                    List<UserDataModel> listob = GetAllTravelList();
                    ViewData["AllTravellist"] = Convert.ToString(listob[0].MessageString);
                }
                catch (Exception ex)
                {
        ...
        public ActionResult PostForm(PostModel postvalues)
        {
            ...
            if (!string.IsNullOrEmpty(userName))
            {
                ...
                {
                    con.Open();
                    SqlCommand dCmd = new SqlCommand("Update_Travel_Post", con);
        ...
        public ActionResult ViewAllTravels()
        {
            List<UserDataModel> ListallTravel = GetAllTravelList();
            return View(ListallTravel);
        }

        public List<UserDataModel> GetAllTravelList()
        {
            SqlDataReader sqdr;
            List<UserDataModel> PostModelList = new List<UserDataModel>();
            SqlConnection con = new SqlConnection(ConnectionString);
            ...
            {
                con.Open();
                SqlCommand JCmdlist = new SqlCommand("GetAllTravelPost", con);
